...
An optional parity bit may be include at the end of data transmission. Odd parity means that sum of all bits gives an odd number and even parity means sum of all the bit gives an even number. Parity bit can be used to check the data is corrctly been transmitted.
